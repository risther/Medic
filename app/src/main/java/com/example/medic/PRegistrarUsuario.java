...
public class PRegistrarUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_registrar_usuario);
        ...
        btnRegistrarCli.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tvdni.equals("") || tvnombres.equals("") || tvapellidos.equals("")|| tvtelefono.equals("")|| tvcorreo.equals("")|| tvContraseña.equals("")){
                    ...
                    Toast.makeText(PRegistrarUsuario.this,"Agregado",Toast.LENGTH_SHORT).show();
                    registrarUsuario();
        ...
        mAuth.createUserWithEmailAndPassword(correo,contraseña).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    Toast.makeText(PRegistrarUsuario.this,"se pudo registrar",Toast.LENGTH_SHORT);
                    ...
                    Toast.makeText(PRegistrarUsuario.this,"No se pudo registrar",Toast.LENGTH_SHORT);
                }
            }
        });
    }
