    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rEspecialidades.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PprincipalAdministrador.this,PRegistrarEspecialidad.class));
                finish();
            }
        });
        ...
        rEspecialistas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PprincipalAdministrador.this,PRegistrarEspecialista.class));
                finish();
            }
        });
